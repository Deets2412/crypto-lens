  ...
  features: { text: string; included: boolean }[];
}[] = [
    {
      ...
      features: [
        ...
        { text: 'AI Intelligence — 5 queries/day (ask the robot)', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'AI Intelligence — 25 queries/day + news analysis', included: true },
        { text: 'Portfolio X-Ray analysis', included: false },
      ],
    },
    {
      ...
      features: [
        ...
        { text: 'AI Intelligence — 100 queries/day + Sonar Pro + deep research', included: true },
